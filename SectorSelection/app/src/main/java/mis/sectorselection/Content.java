...
/**
 * The mis.sectorselection.Content class provides the structure for the Country and City Objects needed for the TapMenu
...
class Content {
    ...
    /*
    getter-methods for the Objects of Class mis.sectorselection.Content
     */
